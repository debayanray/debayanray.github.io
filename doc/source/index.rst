.. debayanray-profile documentation master file, created by
...
administration/DevOps and work with Kubernetes/Docker and gitlab-ci.
...
software development. Played the role of an active developer and
**core reviewer** in subprojects, like `Sushy`_ and `Proliantutils`_, of
`OpenStack Ironic`_ (*Baremetal server provisioning*) project.

Moreover I started my career with C++ and had been with it for the initial 6
years of my career.
